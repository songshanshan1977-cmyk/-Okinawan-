...
const AGENT_ERROR_CODES = Object.freeze({
  ...
  // A3: one-time payment authorization flow.
  SUMMARY_NOT_CONFIRMED: "summary_not_confirmed",
  PAYMENT_AUTHORIZATION_FAILED: "payment_authorization_failed",
  PAYMENT_AUTHORIZATION_EXPIRED_OR_USED: "payment_authorization_expired_or_used",
  PAYMENT_SUMMARY_STALE: "payment_summary_stale",
  PAYMENT_SESSION_FAILED: "payment_session_failed",

  // A3 revision: payment-attempt idempotency.
  PAYMENT_PENDING_IMMUTABLE: "payment_pending_immutable",
  PAYMENT_SESSION_WRITE_FAILED: "payment_session_write_failed",
});
...
const AGENT_ERROR_STATUS = Object.freeze({
  ...
  [AGENT_ERROR_CODES.IDEMPOTENCY_CONFLICT]: 409,
  [AGENT_ERROR_CODES.SUMMARY_STALE]: 409,
  [AGENT_ERROR_CODES.CONFIRMATION_FAILED]: 500,
  [AGENT_ERROR_CODES.UPDATE_FAILED]: 500,
  ...
  [AGENT_ERROR_CODES.SUMMARY_NOT_CONFIRMED]: 409,
  [AGENT_ERROR_CODES.PAYMENT_AUTHORIZATION_FAILED]: 500,
  [AGENT_ERROR_CODES.PAYMENT_AUTHORIZATION_EXPIRED_OR_USED]: 409,
  [AGENT_ERROR_CODES.PAYMENT_SUMMARY_STALE]: 409,
  [AGENT_ERROR_CODES.PAYMENT_SESSION_FAILED]: 500,

  [AGENT_ERROR_CODES.PAYMENT_PENDING_IMMUTABLE]: 409,
  [AGENT_ERROR_CODES.PAYMENT_SESSION_WRITE_FAILED]: 500,
});
