...
const serviceFacts = deepFreeze({
  brand: {
    // Only the currently valid public brand — no legacy/retired name, no
    // alias field of any kind. An earlier revision of this module recorded
    // a retired internal test name here for documentation purposes; that
    // was itself a rule violation (a retired name has no place in a public
    // fact source at all, documented or not) and has been removed. Do not
    // reintroduce a legacy/former-name field without a fresh, explicit
